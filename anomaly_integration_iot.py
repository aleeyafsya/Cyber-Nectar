...
class AnomalyHoneypot:
    ...
    def map_http_to_network_features(self, attack_data):
        ...
        # Standard HTTP requests on IoT devices are usually very fast (< 0.05s)
        duration = 0.02 
        
        # Path heuristics (Safety Valve: Whitelist common benign paths)
    ...
    def process_attack(self, attack_data):
        ...
        # Note: We don't train here because this is UNSUPERVISED. 
